...
public class Score {
    ...
    public String getScores() throws SQLException {
        ...
        // ResultSet rs = man.query("SELECT User, Score, ScoreDate FROM Scoreboard ORDER
        // BY Score DESC");
        // rs.last();
        // rows = rs.getRow();
        // rs.beforeFirst();
        ...
        // while(rs.next())
        // str = str +
        // rs.getString("User")+","+rs.getInt("Score")+","+rs.getString("ScoreDate")+"%";
    ...
    public void addScore(int score, String user) throws SQLException {
        ...
        // man.update("INSERT INTO Scoreboard (User, Score, ScoreDate) VALUES
        // ('"+user+"',"+score+",'"+dateFormat.format(cal.getTime())+"')");
