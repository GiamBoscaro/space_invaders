...
public class Main extends JFrame {
	...
	private void initialize() {
		...
		this.setResizable(false);	//non è possibile modificare le dimensioni del frame
		this.setBounds(new Rectangle(600, 300, 600, 400));	//il frame è rettangolare posizionato nelle coordinate (600,300) dello schermo e di dimensioni 600x400
		...
		menu = new MenuPanel(this, new File("src/img/menu.jpg"));	//inizializzazione del panello del menu, passo il Main e un immagine di background
	...
	public static void main(String[] args) {	//main dell'intera applicazione
		SwingUtilities.invokeLater(new Runnable() {	
			public void run() {
				...
				thisClass.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);	//operazione di base quando il frame viene chiuso (in questo caso interruzione del processo)
